...
//  SuperBest
//
//  Created Alex Misko on 31.10.2022.
//
...
class CheckBoxButtonView: UIView {
    ...
    private func setupView() {
        ...
        checkBoxButton.centerYAnchor.constraint(equalTo: textView.centerYAnchor, constant: 3).isActive = true
        checkBoxButton.translatesAutoresizingMaskIntoConstraints = false
                
        textView.topAnchor.constraint(equalTo: textView.superview!.topAnchor, constant: 0).isActive = true
        ...
        textView.bottomAnchor.constraint(equalTo: textView.superview!.bottomAnchor, constant: 0).isActive = true
