...
class WebViewViewController: UIViewController {
    ...
    private let loaderView: NVActivityIndicatorView = {
        ...
        v.color = UIColor.AppCollors.background
    ...
    private func setupView() {
        view.backgroundColor = .white
        navigationController?.navigationBar.barTintColor = UIColor.AppCollors.background
    ...
    private func addGoBackButton() {
        if webView.canGoBack{
            ...
            button.sizeToFit()
            button.tintColor = .AppCollors.background
